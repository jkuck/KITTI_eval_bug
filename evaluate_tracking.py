...
#        self.sequence_name = [self.sequence_name[0]] #jdk temp hack
...
#        for seq_idx in range(0,1):
            ...
            for f in range(len(seq_gt)):
                ...
                nignoredtracker = 0
                for tt in t:
                    if ((self.cls=="car" and tt.obj_type=="van") or (self.cls=="pedestrian" and tt.obj_type=="person_sitting")) and not tt.valid:
                        nignoredtracker+= 1
                        tt.ignored      = True
                        continue
                    for d in dc:
...
#                print "frame %d has %d false positives, %d total positives, %d ignoredtp, %d true positives, %d ignored tracks" % (f, tmpfp, len(t), nignoredtp, tmptp, nignoredtracker)
